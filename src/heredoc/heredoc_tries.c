...
/*   Updated: 2026/05/20 04:39:12 by kedemiro           ###   ########.fr     */
/*                                                                            */
/* ************************************************************************** */
...
// 	}
// }
// void	init_heredoc(t_sh *sh, t_heredoc *data, t_token *tmp)
// {
// 	while (tmp)
// 	{
// 		data->start = tmp;
...
// void	skip_delimeter(t_token *tmp)
// {
// 	while (tmp)
// 	{
// 		if (tmp->type == TOKEN_HEREDOC)
// 			cut_token_list(tmp, tmp->next);
// 		tmp = tmp->next;
// 	}
// }
